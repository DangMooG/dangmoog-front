...
class _ChooseLockerPageState extends State<ChooseLockerPage> {
  ...
  void _loadLockerData() async {
    try {
      ...
      print(error);
      isLoading =
          false; // Handle errors, such as by displaying an error message
    }
  }
                  ...
                  children: [
                        ...
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            insetPadding: const EdgeInsets.all(
                                10), // Some padding around the dialog
                            content: AspectRatio(
                                aspectRatio:
                                    1, // Set your desired aspect ratio if needed
                                child: ClipRRect(
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          physics:
                              const NeverScrollableScrollPhysics(), // as it is inside another scrollable widget
                          itemCount:
                              4, // Assuming there are 4 lockers in each series A and B
